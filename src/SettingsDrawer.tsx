    ...
    <Drawer opened={props.settingsOpened} onClose={props.closeSettings} position="right">
      <Flex direction="column" w="100%" gap={30}>
        ...
        <Flex justify="space-between" w="100%" align="center">
          ...
          <Flex align="center" gap={30}>
            <Button size="xl" disabled={creditPerCard === 0} onClick={() => setResource("creditPerCard", creditPerCard-1)}>-</Button>
            <Text size="xl">{creditPerCard}</Text>
            <Button size="xl" onClick={() => setResource("creditPerCard", creditPerCard+1)}>+</Button>
          </Flex>
        </Flex>
      </Flex>
    </Drawer>
